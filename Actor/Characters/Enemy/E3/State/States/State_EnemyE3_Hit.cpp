...
void UState_EnemyE3_Hit::Init(class UStateMng_GC* pMng)
{
	Super::Init(pMng);

}

void UState_EnemyE3_Hit::Enter()
{
	Super::Enter();
...
void UState_EnemyE3_Hit::Update(float fDeltaTime)
{
...
void UState_EnemyE3_Hit::StateMessage(FString StateMessage)
{
...
FString UState_EnemyE3_Hit::GetHitDirection()
{
