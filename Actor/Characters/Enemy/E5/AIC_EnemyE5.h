...
#include "AIC_EnemyE5.generated.h"

/**
 * 
 */
UCLASS()
class REVENGER_API AAIC_EnemyE5 : public AAIController
{
	GENERATED_BODY()
	
private:
	UPROPERTY()
		class AEnemyE5* m_pRoot;

	UPROPERTY()
		class UStateMng_AI_EnemyE5* m_pStateMng;
...
public:
	FORCEINLINE class AEnemyE5* GetRootChar() { return m_pRoot; }
