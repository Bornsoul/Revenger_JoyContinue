...
void UState_EnemyE5_Hit::Init(class UStateMng_GC* pMng)
{
	Super::Init(pMng);

}

void UState_EnemyE5_Hit::Enter()
{
	Super::Enter();
...
void UState_EnemyE5_Hit::Update(float fDeltaTime)
{
...
void UState_EnemyE5_Hit::StateMessage(FString StateMessage)
{
...
FString UState_EnemyE5_Hit::GetHitDirection()
{
