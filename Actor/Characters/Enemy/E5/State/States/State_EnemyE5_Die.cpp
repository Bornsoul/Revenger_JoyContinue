...
void UState_EnemyE5_Die::Init(class UStateMng_GC* pMng)
{
	Super::Init(pMng);

}

void UState_EnemyE5_Die::Enter()
{
	Super::Enter();
...
void UState_EnemyE5_Die::StateMessage(FString StateMessage)
{
...
FString UState_EnemyE5_Die::GetHitDirection()
{
	FVector pHitDirection = m_vHitDirection - GetRootCharacter()->GetActorLocation();
	pHitDirection.Normalize();
