...
void UState_GBEL_Die::Init(class UStateMng_GC* pMng)
{
	Super::Init(pMng);

}

void UState_GBEL_Die::Enter()
{
	Super::Enter();
...
void UState_GBEL_Die::StateMessage(FString StateMessage)
{
...
FString UState_GBEL_Die::GetHitDirection()
{
	FVector pHitDirection = m_vHitDirection - GetRootCharacter()->GetActorLocation();
	pHitDirection.Normalize();
