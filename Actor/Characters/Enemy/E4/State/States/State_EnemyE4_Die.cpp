...
void UState_EnemyE4_Die::Init(class UStateMng_GC* pMng)
{
	Super::Init(pMng);

}

void UState_EnemyE4_Die::Enter()
{
	Super::Enter();
...
void UState_EnemyE4_Die::StateMessage(FString StateMessage)
{
...
FString UState_EnemyE4_Die::GetHitDirection()
{
	FVector pHitDirection = m_vHitDirection - GetRootCharacter()->GetActorLocation();
	pHitDirection.Normalize();
