#include "CamAction_Parring.h"
#include "../Cpt_CamAction.h"
#include "Kismet/KismetMathLibrary.h"

void UCamAction_Parring::ActiveAction()
{
...
void UCamAction_Parring::DeActiveAction()
{
	m_bAimComp = false;
	m_bActive = false;
...
void UCamAction_Parring::Tick_Action(float fDeltaTime)
{
